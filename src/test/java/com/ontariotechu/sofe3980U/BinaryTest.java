...
public class BinaryTest
{
    ...
    public void testMultiply() {
        // Arrange
        Binary binaryMul1 = new Binary("1101");
        Binary binaryMul2 = new Binary("1010");
        ...
        public void testAnd() {
            ...
            // Assert
            assertEquals("Binary AND: ", "1000", result.getValue());
        }

        @Test
        public void testAndUnequalLength() {
            // Arrange
            Binary binary1 = new Binary("1101");
    ...
    public void testOr() {
        ...
        // Assert
        assertEquals("Binary OR: ", "1111", result.getValue());
    }

    @Test
    public void testOrUnequalLength() {
        // Arrange
        Binary binary1 = new Binary("1101");
        Binary binary2 = new Binary("10");
    ...
    public void testOrZero() {
        ...
        // Assert
        assertEquals("Binary OR with zero: ", "1010", result.getValue());
    }
